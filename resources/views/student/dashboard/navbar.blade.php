    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                @php
                    $segments = array_filter(explode('/', str_replace(route('student.dashboard'), '', Request::url())));
                ...
                @else
                    <li class="active">
                        <a href="{{ route('student.dashboard')}}"><i class="voyager-boat"></i> {{ __('voyager::generic.dashboard') }}</a>
                    </li>
