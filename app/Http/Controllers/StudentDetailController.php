...
class StudentDetailController extends VoyagerController\VoyagerBaseController
{
    //
    ...
    public function details($id = null){
        ...
        $data=[];
        $data['student_details'] = User::findOrFail($id);

        if (view()->exists("voyager::student-details.details")) {
            $view = "voyager::student-details.details";
        }
    ...
    public function index(Request $request)
    {
        ...
        //query
        $dataTypeContent = User::where('role_id', 3)->with('student_details')->latest()->get();
